...
public class ReservationService {
    ...
    public ReservationService(ReservationRepository reservationRepository, UserRepository userRepository,
            GuideRepository guideRepository, TravelPackageRepository travelPackageRepository) {
    ...
    public ReservationResponseDTO createReservation(ReservationRequestDTO requestDTO, String email) {
        ...
        TravelPackage travelPackage = travelPackageRepository.findById(requestDTO.getTravelPackageId())
                .orElseThrow(() -> new ResourceNotFoundException("TravelPackage not found"));

        Guide guide = guideRepository.findByAvailable(true)
                .stream()
                .findFirst()
                .orElseThrow(() -> new ResourceNotFoundException("No guides availables at the moment"));

        guide.setAvailable(false);
        guideRepository.save(guide);

        Reservation reservation = new Reservation(date, requestDTO.getNumberOfPeople(), ReservationStatus.PENDING, user,
                travelPackage, guide);
