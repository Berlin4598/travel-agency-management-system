...
public class DestinationService {
    ...
    private DestinationResponseDTO toResponseDTO(Destination destination) {
        return new DestinationResponseDTO(destination.getId(),destination.getCity(), destination.getCountry(),
                destination.getDescription(),destination.getImageUrl());
    }
    ...
    public DestinationResponseDTO updateDestination(Long id, DestinationRequestDTO requestDTO) {
        ...
        destination.setImageUrl(requestDTO.getImageUrl());
